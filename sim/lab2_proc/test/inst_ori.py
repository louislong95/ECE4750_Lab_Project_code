...
def gen_src_eq_dest_test():
  return [
    ...
    gen_rimm_src_eq_dest_test( "ori", 0x00000fff, 0xf00, 0xffffffff ),
    gen_rimm_src_eq_dest_test( "ori", 0x0000000f, 0xf00, 0xffffff0f ),
    gen_rimm_src_eq_dest_test( "ori", 0x00000000, 0xf00, 0xffffff00 ),
    gen_rimm_src_eq_dest_test( "ori", 0x000000f0, 0xf0f, 0xffffffff ),
    gen_rimm_src_eq_dest_test( "ori", 0x00000000, 0x000, 0x00000000 ),
  ]
