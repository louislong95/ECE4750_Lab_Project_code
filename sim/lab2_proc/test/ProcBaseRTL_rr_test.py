...
# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_mul_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_mul.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_mul_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_mul.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_mul_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_mul.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_mul_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_mul.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_mul_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_mul.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#-------------------------------------------------------------------------
...
@pytest.mark.parametrize( "name,test", [
  asm_test( inst_slts.gen_basic_test     ) ,

  # ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  # Add more rows to the test case table to test more complicated
  # scenarios.
  asm_test( inst_slts.gen_dest_dep_test  ) ,
  asm_test( inst_slts.gen_src0_dep_test  ) ,
  asm_test( inst_slts.gen_src1_dep_test  ) ,
  asm_test( inst_slts.gen_srcs_dep_test  ) ,
  asm_test( inst_slts.gen_srcs_dest_test ) ,
  asm_test( inst_slts.gen_value_test     ) , 
  asm_test( inst_slts.gen_random_test    ) ,
  # ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
])
def test_slts( name, test, dump_vcd ):
  run_test( ProcBaseRTL, test, dump_vcd )

# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_slts_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_slts.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_slts_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_slts.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_slts_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_slts.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_slts_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_slts.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_slts_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_slts.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#-------------------------------------------------------------------------
...
# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_sltu_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_sltu.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sltu_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_sltu.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_sltu_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_sltu.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sltu_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_sltu.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_sltu_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_sltu.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#-------------------------------------------------------------------------
...
# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_sra_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_sra.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sra_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_sra.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_sra_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_sra.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sra_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_sra.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_sra_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_sra.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#-------------------------------------------------------------------------
...
# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_srl_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_srl.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_srl_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_srl.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_srl_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_srl.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_srl_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_srl.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_srl_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_srl.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#-------------------------------------------------------------------------
...
# ''' LAB TASK '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# random stall and delay
def test_sll_rand_delays_1( dump_vcd ):
  run_test( ProcBaseRTL, inst_sll.gen_random_test, dump_vcd,
            src_delay=0, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sll_rand_delays_2( dump_vcd ):
  run_test( ProcBaseRTL, inst_sll.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=0, mem_stall_prob=0.5, mem_latency=3 )

def test_sll_rand_delays_3( dump_vcd ):
  run_test( ProcBaseRTL, inst_sll.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

def test_sll_rand_delays_4( dump_vcd ):
  run_test( ProcBaseRTL, inst_sll.gen_random_test, dump_vcd,
            src_delay=5, sink_delay=5, mem_stall_prob=0.5, mem_latency=10 )

def test_sll_rand_delays_5( dump_vcd ):
  run_test( ProcBaseRTL, inst_sll.gen_random_test, dump_vcd,
            src_delay=10, sink_delay=10, mem_stall_prob=0.8, mem_latency=10 )
# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
