...
def gen_dest_dep_test():    # test the nop between andi and csrw, the nop between csrr and addi is always 8
  return [
...
def gen_src_dep_test():   #  test the nop between csrr and andi, the nop between addi and csrw is always 0
  return [
...
def gen_src_eq_dest_test(): # the nop between csrr and addi, addi and csrw are always 0
  return [
    ...
    gen_rimm_src_eq_dest_test( "andi", 0x00000fff, 0xff0, 0x00000ff0 ),
    gen_rimm_src_eq_dest_test( "andi", 0x00000f0f, 0xfff, 0x00000f0f ),
    gen_rimm_src_eq_dest_test( "andi", 0x0000000f, 0xff0, 0x00000000 ),
    gen_rimm_src_eq_dest_test( "andi", 0x000000f0, 0xff0, 0x000000f0 ),
...
def gen_value_test():
  return [
    ...
    gen_rimm_value_test( "andi", 0xf00ff00f, 0xfff, 0xf00ff00f ),
    gen_rimm_value_test( "andi", 0xf00ff00f, 0x000, 0x00000000 ),
  ]
